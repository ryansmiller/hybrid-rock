...
add_action( 'after_setup_theme', 'hybrid_rock_custom_background_setup', 15 );
 ...
 * @return void
 */
function hybrid_rock_custom_background_setup() {
	...
	add_theme_support(
		...
		array(
			...
			'default-image'    => '',
			'wp-head-callback' => 'hybrid_rock_custom_background_callback',
		)
	);
}
 ...
 * @return void
 */
function hybrid_rock_custom_background_callback() {
